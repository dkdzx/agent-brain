#!/usr/bin/env python3
"""Project-owned, task-scoped shared working memory for Codex workgroups.
...
SCHEMA_VERSION = "agent_brain_workgroup_runtime_v0_1"
...
def command_handoff(args: argparse.Namespace) -> dict[str, Any]:
    ...
    with group_lock(group_dir):
        ...
        handoff = {
            ...
            "promotion": {
                "project_control_review_required": True,
